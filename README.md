...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-blob-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-blob-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-blob-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-blob-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-blob-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-blob-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-blob/badges/version.svg)](https://anaconda.org/conda-forge/r-blob)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-blob/badges/downloads.svg)](https://anaconda.org/conda-forge/r-blob)
